import cffi
from .race_env import lib as cpenv#.reset, step, get_state, init, get_done_status, get_position_x, get_position_y, get_rotation, get_speed, get_direction, get_step_count, set_step_data, get_dist_save_a, get_dist_save_b, cast_ray_x, cast_ray_y, get_distance_at, get_distances, load_terrain_file, add_car_collision_points, reset_collision_points
...
class Env(gym.Env):
    ...
    def __init__(self, init_all=False, max_step=10000):
        ...
        max_scan_distance = math.sqrt(self.WIDTH*self.WIDTH + self.HEIGHT*self.HEIGHT)
